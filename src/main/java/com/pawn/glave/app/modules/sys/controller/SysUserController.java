...
import com.pawn.glave.app.common.utils.ExcelUtils;
import com.pawn.glave.app.common.utils.PageUtils;
import com.pawn.glave.app.common.utils.R;
import com.pawn.glave.app.common.validator.Assert;
...
import com.pawn.glave.app.modules.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
	...
	public R info(@PathVariable("userId") Long userId){
		...
		Map<String,Object> dept = sysDeptService.getUserDept(userId);
		user.setDept(MapUtils.getString(dept,"dept_id"));
		user.setIsLeader(MapUtils.getString(dept,"is_leader"));
	...
	public R export(@RequestParam Map<String, Object> params, HttpServletResponse response) throws IOException {
		...
		ExcelUtils.exportExcel(userList,"人员信息","人员信息",SysUserEntity.class,"人员信息",response);
		return R.ok();
	}
}
