...
public class WxPayUtil {
    ...
    public static String mapToXml(Map<String, Object> data) {
        ...
        try {
            ...
            throw new RuntimeException("转XML格式失败！");
        }
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        ...
        String sign = MapUtils.getString(data,WxPayConstants.FIELD_SIGN);
     ...
     * @see Exception
     */
    public static String generateSignature(final Map<String, Object> data, String key, WxPayConstants.SignType signType) {
    ...
    public static String HMACSHA256(String data, String key) {
        ...
        try {
            ...
            throw new RuntimeException("HMACSHA256加密错误！");
        }
