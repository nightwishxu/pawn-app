...
import com.pawn.glave.app.modules.sys.service.SysRoleService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	public void saveUser(SysUserEntity user) {
		...
		// 保存用户与部门关系
		sysDeptService.saveUserDept(user.getUserId(),user.getDept(),user.getIsLeader());
	}
	...
	public void update(SysUserEntity user) {
		...
		// 修改用户与部门关系 先删除 再插入
		sysDeptService.deleteUserDept(user.getUserId(),user.getDept());
		sysDeptService.saveUserDept(user.getUserId(),user.getDept(),user.getIsLeader());
	}
